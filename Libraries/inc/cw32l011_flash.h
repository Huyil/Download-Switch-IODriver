...
#ifndef __CW32L011_FLASH_H__
#define __CW32L011_FLASH_H__
...
#define FLASH_Latency_4                   ((uint32_t)0x00000004)  /*!< FLASH Three Latency cycles */
...
#define IS_FLASH_PAGE_Number(PAGENUMBER)  ((PAGENUMBER) < FLASH_PAGES_SIZE)
...
//解锁FLASH指定页面：按照页面号解锁，0~FLASH_PAGES_SIZE-1
...
//擦除FLASH指定页面：按照页面号擦除，0~FLASH_PAGES_SIZE-1
...
//锁定FLASH指定页面：按照页面号锁定，0~FLASH_PAGES_SIZE-1

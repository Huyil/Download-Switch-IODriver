...
//    CW_ATIM->CCMR1CMP_f.OC2M = (ATIM_OCMODE_FORCED_INACTIVE);  
//    CW_ATIM->CCMR1CMP_f.OC1M = (ATIM_OCMODE_FORCED_INACTIVE);
//    CW_GTIM2->CCMR2CMP_f.OC4M = (ATIM_OCMODE_FORCED_INACTIVE);
 ...
 */
void GTIM1_IRQHandler1(void)
{
    /* USER CODE BEGIN */
  CW_GTIM1->ICR = 0;
    /* USER CODE END */
}
void GTIM2_IRQHandler1(void)
{
  CW_GTIM2->ICR = 0;
};
/**
